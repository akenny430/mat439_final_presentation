plot_set_peak <- function(peak) {
  par(bg = "#2C2C2E", fg = "#F2F2F7", col.axis = "#F2F2F7", col.lab = "#F2F2F7",
      mar = c(4.5, 4.5, 1, 1), las = 1, bty = "o", xaxt = "s", yaxt = "s")
  plot(1, type = "n", xlim = c(0, 1), ylim = c(0, 1), xlab = "S", ylab = "I",
       bty = "o", xaxt = "n", yaxt = "n", cex.lab = 1.5)
  axis(side = 1, at = seq(0, 1, 0.2), labels = c("0", "", "", "", "", "N"), tck = -0.025)
  axis(side = 1, at = peak, labels = expression(S[p]), tck = 0)
